...
async function main() {
    ...
    // 1 set startTime
    // const startTime = Date.UTC(2022, 4, 21, 0, 0, 0) / 1000;
    ...
    ////////////////////////////////////////////////////////
    // 02 uint256 _allocPoint, IERC20 _lpToken, uint256 _depositFeePercent, IOnwardIncentivesController _incentivesController, bool _boost, bool _withUpdate
